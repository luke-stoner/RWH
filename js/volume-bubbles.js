...
// Function to initialize and animate the bubble chart
...
function handleIntersection(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            // Initialize the bubble chart when the element is visible
            initBubbleChart();

            // Optional: Stop observing the element after it has been initialized
...
let target = document.getElementById('volume-bubbles');
